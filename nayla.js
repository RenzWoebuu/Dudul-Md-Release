...
┃╭──────────────────
║│~ ═[ *PERATURAN GRUB* ]
┃│✄ *Dilarang Share link Grub/GTPS lain*
║│✄ *Dilarang Spam Bot*
┃│✄ *Dilarang Share 18+*
║│✄ *Dilarang Membully Member Lain*
┃╰──────────────────
╚━══━══━══━══━══━══━
▬▭▬▭▬▭▬▭▬▭▬▭▬▭
╔━══━══━══━══━══━══━
...
╚━══━══━══━══━══━══━
▬▭▬▭▬▭▬▭▬▭▬▭▬▭`
await sendMenu(from, menu, "Lightweight full-featured WhatsApp Web + Multi-Device API", await nayla.sendnew(from, {video: {url: "./media/video/menu.jpg", caption: menu}, gifPlayback: true}))
break
case 'menu':
if (isLimit(sender)) return reply("YAHHH LIMIT KAMU UDAH HABIS")
await limitAdd(sender) 
...
await sendMenuu(from, menuu, `full-featured WhatsApp Web + Multi-Device API`, await nayla.sendnew(from, {video: {url: "./media/video/menuu.jpg", caption: menuu}, gifPlayback: true}))
break
case 'desk':
if (isLimit(sender)) return reply("YAHHH LIMIT KAMU UDAH HABIS")
await limitAdd(sender) 
